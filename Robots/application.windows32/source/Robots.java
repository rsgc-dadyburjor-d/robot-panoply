...
public void draw() {
  ...
  imageMode(CENTER);
    ...
    rotate(-.1f); 
    spencerRobot.drawAt(540, 200, 3.5f, 3.5f); //robot2
    ...
    //robots
    spencerRobot.drawAt(379, 404, 2.9f, 2.9f);
    benRobot.drawAt(759, 281, 0.4f, 0.4f);
    danielRobot.drawAt(666, 416, 0.2f, 0.2f);
 img = loadImage("logo.png"); //scene1 bg texture
  imageMode(CENTER);
    img.resize(10500 / scale  , 10500 / scale );
    image(img, mouseX, mouseY); 
    ...
    //robots
    timRobot.drawAt(540, 350, 1, 1.5f); //robot 1
...
public void keyPressed() { //advances scene on keypress
  scene += 1;
}
class ASPRobot { 
...
//let xAnchor be x
    ...
    public void drawAt(int x, int y, float a, float b) {
